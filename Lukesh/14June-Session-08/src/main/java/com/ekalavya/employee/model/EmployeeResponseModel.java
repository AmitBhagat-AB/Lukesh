...
public class EmployeeResponseModel {
	...
	public EmployeeResponseModel(String employeeReferenceNumber, String firstName, String lastName, String address,
			String city, String state, String mobileNumber, String emailId) {
		super();
		this.employeeReferenceNumber = employeeReferenceNumber;
		this.firstName = firstName;
		this.lastName = lastName;
	...
	public String toString() {
		return "EmployeeResponseModel [employeeReferenceNumber=" + employeeReferenceNumber + ", firstName=" + firstName
