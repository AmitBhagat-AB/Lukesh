...
public class EmployeeServiceImpl implements EmployeeService {
	...
	@Override
	public List<EmployeeResponseData> getEmployeeByFirstNameAndLastName(String firstName, String lastName) {

		List<EmployeeResponseData> listEmployee = new ArrayList<>();

		List<EmployeeDto> listEmployeeDto = employeeDao.getEmployeeByFirstNameAndLastName(firstName ,lastName);
