...
public class EmployeeController {
	...
	public ResponseEntity<List<EmployeeResponseData>> getEmployeeByName(@RequestParam (required = false) String firstName ,String lastName) {

		List<EmployeeResponseData> listEmployee = employeeService.getEmployeeByFirstNameAndLastName( firstName, lastName);
