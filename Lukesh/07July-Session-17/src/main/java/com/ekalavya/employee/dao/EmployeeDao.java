...
//			listEmployeeEntity = (List<EmployeeEntity>) employeeRepository.findByFirstNameOrLastName(firstName, lastName);
			listEmployeeEntity = (List<EmployeeEntity>) employeeRepository.findByFirstNameOrLastNameOrderByFirstName(firstName, lastName);
